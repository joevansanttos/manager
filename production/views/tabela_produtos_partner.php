...
<div class="x_title">
  <h2>Lista de Produtos e seus Valores <small>Valores relacionados a negócios de Partner</small></h2>
...
<table id="tabela" class="table table-bordered">
	<thead>
		<tr>
			<th>Produto</th>
			<th class="col-md-2">Micro/Partner</th>                              
			<th class="col-md-2">Pequena/Partner</th>                              
			<th class="col-md-3">Média/Grande/Partner</th>
	<?php
	  if($usuario->getId() == 1){
	?>  
			<th>Ações</th>
