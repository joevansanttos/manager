...
<div class="x_title">
  <h2>Alterar Receita do Planejamento</h2>
...
<form action="../altera/altera_planejamento_receita.php?id=<?=$id?>" method="post" id="demo-form2" enctype="multipart/form-data" data-parsley-validate class="form-horizontal form-label-left">                      
  ...
  <div class="form-group">
    ...
    <div class="col-md-2 col-sm-3 col-xs-4">
      <input type="date" id="data" name="data" value="<?=$planejamentoReceita->getData()?>" required="required"  data-validate-length-range="8,20" class=" date-picker form-control col-md-8 col-xs-12">
    </div> 
    ...
    <div class="col-sm-2 col-xs-12 col-md-3">
      <input type="text" id="valor" name="valor" onblur="convert()" value="<?=$planejamentoReceita->getValor()?>" required="required" data-validate-length-range="8,20" class="form-control col-md-7 col-xs-12">
    </div>      
  </div>
  <div class="form-group">
  ...
  <div class=" form-group">
    <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
      ...
      <input type="hidden" name="planejamento_id" id="id" value="<?=$planejamentoReceita->getPlanejamento()->getId()?>" />
    </div>
  </div>
</form>
...
<script type="text/javascript">
  document.getElementById('market_id').value = '<?=$planejamentoReceita->getMarket()->getId()?>';
</script>

<script type="text/javascript">
  document.getElementById('categoria_id').value = '<?=$planejamentoReceita->getCategoria()->getId()?>';
</script>

<script type="text/javascript">
  document.getElementById('pagamento_id').value = '<?=$planejamentoReceita->getPagamento()->getId()?>';
</script>
