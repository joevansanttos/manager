...
<div class="x_title">
  <h2>Adicionar Nova Despesa de Colaborador</h2>
...
<form action="../adiciona/adiciona_custo.php" method="post" id="demo-form2" enctype="multipart/form-data" data-parsley-validate class="form-horizontal form-label-left">                      
