...
<div class="x_title">
  <h2>Alterar Contato de Fornecedor</h2>
...
<form action="../altera/altera_contato_fornecedor.php?id=<?=$id?>" method="post" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
...
<script type="text/javascript">
  document.getElementById('fornecedor_id').value = '<?=$contato->getFornecedor()->getId()?>';
</script>
