...
<div class="x_title">
  <h2>Adicionar Nova Despesa ao Planejamento</h2>
...
<form action="../adiciona/adiciona_planejamento_despesa.php" method="post" id="demo-form2" enctype="multipart/form-data" data-parsley-validate class="form-horizontal form-label-left">                      
  ...
  <div class="form-group">
    ...
    <div class="col-md-6 col-sm-6 col-xs-12">
      <input class="form-control col-md-3 col-sm-3 col-xs-12" value="<?=$planejamento->getAno()?>" readonly="readonly" type="text" id="ano" data-inputmask="'mask' : '9999'" name="ano" required="required"> 
    </div>
  </div>
  ...
  <div class=" form-group">
    <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
      ...
      <input type="hidden" name="planejamento_id" id="id" value="<?=$id?>" />
    </div>
  </div>
</form>
