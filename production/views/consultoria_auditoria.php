...
<div class="x_title">
  <h2>Lista de Projetos de Auditoria de Processos</h2>
 ...
 <thead>
   ...
   <tbody>
    <?php
      ...
      if($usuario_id == 1){
        $contratos = $contratoDao->listaContratosAuditoria(); 
      }else{
        $contratos = $contratoDao->listaContratosAuditoriaConsultor($usuario_id); 
      }
