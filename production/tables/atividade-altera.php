...
<form id="form" action="../altera/altera-atividade.php?id=<?=$id?>" method="post"  enctype="multipart/form-data" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
  <div class="form-group">
    ...
    <div class="col-md-6 col-sm-6 col-xs-12">
      <input type="text" id="nome" name="descricao" value="<?=$atividade->getDescricao()?>" required="required" class="form-control col-md-7 col-xs-12">
    </div>
  </div>
  <div class="item form-group">
    ...
    <div class="col-sm-2 col-xs-12 col-md-2">
      <input type="date" id="inicio" name="inicio" required="required" value="<?=$atividade->getInicio()?>" data-validate-length-range="8,20" class="form-control col-md-7 col-xs-12">
    </div>
    <label class="control-label col-md-2 col-sm-3 col-xs-12" for="fechamento">Prazo</label>
    <div class="col-sm-2 col-xs-12 col-md-2">
      <input type="date" id="prazo" name="prazo" required="required" value="<?=$atividade->getPrazo()?>" data-validate-length-range="6,20" class="form-control col-md-7 col-xs-12">
    </div>
  </div>
  <div class="form-group">
    ...
    <div class="col-md-6 col-sm-6 col-xs-12">
      <input type="text" id="nome" name="setor" value="<?=$atividade->getSetor()?>" required="required" class="form-control col-md-7 col-xs-12">
    </div>
  </div>
  <div class="form-group">
    ...
    <div class="col-md-6 col-sm-6 col-xs-12">
      <input type="text" id="nome" name="filial" value="<?=$atividade->getFilial()?>" required="required" class="form-control col-md-7 col-xs-12">
    </div>
  </div>
  <div class="form-group">
    ...
    <div class="col-md-6 col-sm-6 col-xs-12">
      <input type="text" id="nome" name="importancia" value="<?=$atividade->getImportancia()?>" required="required" class="form-control col-md-7 col-xs-12">
    </div>
  </div>
  <div class="form-group">
    ...
    <div class="col-md-6 col-sm-6 col-xs-12">
      <textarea  name="resultados" class="form-control col-md-12 col-xs-12"  rows="6"><?=$atividade->getResultados()?></textarea> 
    </div>
  </div>
  <div class="item form-group">
  ...
  <div class=" form-group">
    <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
      ...
      <input type="hidden" name="usuario_id" id="id" value="<?=$atividade->getUsuario()->getId()?>" />
    </div>
  </div>
</form>
