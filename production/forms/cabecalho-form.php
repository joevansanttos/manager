              ...
              <ul class="nav side-menu">
                <li><a><i class="fa fa-home"></i> Menu<span class="fa fa-chevron-down"></span></a>
                  <ul class="nav child_menu">
                    <li><a href="../tables/dashboard.php">Dashboard</a></li>
                  </ul>
                </li>                                  
                <li><a><i class="fa fa-user"></i> Usuários<span class="fa fa-chevron-down"></span></a>
                  <ul class="nav child_menu">
                    <li><a href="../tables/usuarios.php">Consultores</a></li>
                  </ul>
                </li>
                <li><a><i class="fa fa-rocket"></i> Produtos<span class="fa fa-chevron-down"></span></a>
                  <ul class="nav child_menu">
                    <li><a href="../tables/produtos.php">Produtos</a></li>
                  </ul>
                </li>
                <li><a><i class="fa fa-briefcase"></i> Negócios <span class="fa fa-chevron-down"></span></a>
                  <ul class="nav child_menu">
                    <li><a href="../tables/market.php">Market</a></li>
                    <li><a href="../tables/leads.php">Leads</a></li>
                    <li><a href="../tables/suspects.php">Suspects</a></li>
                    <li><a href="../tables/prospects.php">Prospects</a></li>
                  </ul>
                </li>
